...
import { createVisit, getAllVisitsCount, getCancelledVisits, getCompletedVisits, getConfirmedVisits, getConfirmedVisitsCount, getPastVisits, getPendingVisits, getPendingVisitsCount, getUpcomingVisits, updateVisit, updateVisitStaff } from "../controller/visits.admin.controller.js";
...
router.get('/get-all-visits-count/:client', verifyJWT, isAdmin, getAllVisitsCount);
router.get('/get-pending-visits-count/:client', verifyJWT, isAdmin, getPendingVisitsCount)
router.get('/get-confirmed-visits-count/:client', verifyJWT, isAdmin, getConfirmedVisitsCount)
