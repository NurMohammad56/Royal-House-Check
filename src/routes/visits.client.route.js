...
import { createVisit, getCancelledVisits, getConfirmedVisits, getPendingVisits, getCompletedVisits, getVisitById, updateVisit, getNextVisit, getPastVisits, getUpcomingVisits } from "../controller/visits.client.controller.js";
...
router.get('/get-past-visits', verifyJWT, isClient, getPastVisits)
router.get('/get-upcoming-visits', verifyJWT, isClient, getUpcomingVisits)
router.get('/get-visit/:id', verifyJWT, isClient, getVisitById)
router.get('/get-next-visit', verifyJWT, isClient, getNextVisit)
